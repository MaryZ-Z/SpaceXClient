package com.example.testcaseci.ui.launchdetail
...
import com.example.testcaseci.common.UiListState
import com.example.testcaseci.common.UiState
import com.example.testcaseci.data.launches.QueryLaunches
import com.example.testcaseci.data.launchdetail.Crew
import com.example.testcaseci.ui.components.ErrorScreen
import com.example.testcaseci.ui.components.LoadingScreen
...
fun LaunchDetail(launch: QueryLaunches) {
    ...
    Column(
        ...
        Image(
            ...
            painter = rememberAsyncImagePainter(model = launch.links.patch.large),
